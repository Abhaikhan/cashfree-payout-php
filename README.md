...
The kit reads beneficary details from the index.php file. Under the beneficiary object. For a list of required fields go [here](https://dev.cashfree.com/api-reference/payouts-api#create-beneficiary).
